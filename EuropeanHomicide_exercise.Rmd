...
# YOUR CODE HERE:
library (tidyverse)
kings <- read_csv("kings.csv", na="NULL")
kings %>% 
...
-Throughout the data in regards to the reign of Danish monarchs, we can see a near constant rise in the average time a ruler reigned.  At the same time we can see a major decline in the homicide rate of Scandinavia and other parts of Europe during this time period. So in general there seems to be a decline in homicides and either an increased average lifespan of each ruler or an increased reign. I presume that the decline in homicides might be explained by the increased stability and centralization associated with longer reigning rulers, and a decline in the number of conflicts regarding the Danish throne, but the decline in homicides seems to be a general European trend.
**Final tasks:**
...
-I do not believe that “civilised” would be the right term for it, but I do believe that the decline in homicide rates shows that our modern society is significantly safer than previous time periods. The word “civilised” in general seems highly inappropriate to be used in these kinds of contexts, because the term is always highly subjective, charged and it postulates the existence of something that is not “civilised”. Almost all of the countries that are experiencing these major declines in their homicide rates, are at the same time committing atrocities in the rest of the world during the 20th century. But one can still argue that society has significantly developed in a positive direction in regards to the frequency of homicides during the time periods shown. The development of a modern legal system, the introduction of national police forces and the development of a modern state apparatus in general, probably played a large role in this reduction.